...
def build_smeft_green_bpreserving(
    *,
    ...
    LF2DH2 = (
        ...
        * Phi.bar(w1)
        * Phi(w1)
        * DC(ql(w=w2, f=f1, c=c1, bar=True), mu)
        * Gamma(mu)
        * ql(w=w2, f=f2, c=c1)
        + p["alphaRHq1pp"](f1, f2)
